...
def parse_options(is_train=True):
    ...
    parser.add_argument('--use_penalization', type=lambda x: (str(x).lower() == 'true'), default=None, help='Use penalization for denoising validation')

    args = parser.parse_args()
    opt = parse(args.opt, is_train=is_train)

    # override the use_penalization flag in yml file if provided in the command line
    if args.use_penalization is not None:
        opt['train']['use_penalization'] = args.use_penalization
